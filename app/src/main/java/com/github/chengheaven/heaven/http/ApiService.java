...
public interface ApiService {
    ...
    Call<ResponseBody> getFrontpage();
    ...
    Call<ResponseBody> getGankIoData(@Path("type") String id, @Path("page") int page, @Path("pre_page") int pre_page);
    ...
    Call<ResponseBody> getGankIoDay(@Path("year") String year, @Path("month") String month, @Path("day") String day);
    ...
    @GET("search/query/{content}/category/{type}/count/{per_page}/page/{page}")
    Call<ResponseBody> getSearchData(@Path("content") String content, @Path("type") String type, @Path("per_page") int per_page, @Path("page") int page);
}
