...
public class LiteratureFragment extends BaseFragment implements LiteratureContract.View {
    ...
    private LiteratureContract.Presenter mPresenter;

    public static LiteratureFragment newInstance(String param) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new LiteratureAdapter();
        ...
        mBookRecycler.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onRefresh() {
                start = 0;
                mPresenter.getLiteratureList(getString(R.string.refresh), mType, start, count);
            }

            @Override
            public void onLoadMore() {
                start += count;
                mPresenter.getLiteratureList(null, mType, start, count);
            }
        });
    ...
    public void setPresenter(BasePresenter presenter) {
        mPresenter = (LiteratureContract.Presenter) presenter;
    }
    ...
    @Override
    public void refreshLiteratureView(List<BookBean> results) {
        mBookRecycler.refreshComplete();
        mAdapter.refreshList(results);
    }

    @Override
    public void updateLiteratureView(List<BookBean> results) {
        mBookRecycler.refreshComplete();
        mAdapter.updateList(results);
    }

    class LiteratureAdapter extends RecyclerView.Adapter<LiteratureAdapter.ViewHolder> {
