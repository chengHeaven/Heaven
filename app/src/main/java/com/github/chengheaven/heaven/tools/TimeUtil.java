...
public class TimeUtil {
    ...
    public static ArrayList<String> getLastTime(String year, String month, String day) {
        ...
        if (ca.get(Calendar.DAY_OF_WEEK) != Calendar.SUNDAY && ca.get(Calendar.DAY_OF_WEEK) != Calendar.MONDAY) {
            ca.set(Calendar.DATE, inDay - 1);
        } else if (ca.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY) {
            ca.set(Calendar.DATE, inDay - 2);
        } else if (ca.get(Calendar.DAY_OF_WEEK) == Calendar.MONDAY) {
            ca.set(Calendar.DATE, inDay - 3);
        }
